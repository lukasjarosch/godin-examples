...
import (
	...
	"github.com/lukasjarosch/godin-examples/hello/internal/amqp"
	"net"
	"net/http"
	"os"
	"os/signal"
	...
	svcGrpc "github.com/lukasjarosch/godin-examples/hello/internal/grpc"
	...
	"github.com/lukasjarosch/godin-examples/hello/internal/service/middleware"
	"github.com/lukasjarosch/godin-examples/hello/internal/service/usecase"
...
func main() {
	...
	if err := subscriptions.UserCreatedSubscription(logger, svc); err != nil {
