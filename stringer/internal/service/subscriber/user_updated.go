...
// UserUpdatedSubscriber is responsible of handling all incoming AMQP messages with routing key 'user.updated'
func UserUpdatedSubscriber(logger log.Logger, usecase service.Stringer) rabbitmq.SubscriptionHandler {
	return func(ctx context.Context, delivery *rabbitmq.Delivery) {
		...
		// TODO: Handle user.updated subscription
		/*
